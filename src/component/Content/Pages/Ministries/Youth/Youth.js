  ...
  return (
    <>
      ...
      <div className=' px-5 mx-5'>
        ...
        <h2 className='py-5 text-center text-red-600 text-5xl tracking-widest font-bold uppercase'>Youth Fellowship</h2>
      </div>
      
      <div className=' px-5 mx-5 py-10'>
        <p className=' mx-5 w-fit'>
          The Youth Fellowship is a ministry in the church that brings together people from all walks of life and integrates them into  the body of Christ- the church.
